...
const Success = () => {
  return (
    <div className="relative flex mb-[20rem] md:mb-0 max-w-[375px] md:max-w-full sm:max-w-full mx-auto md:mx-0 justify-center md:justify-start sm:justify-start">
      ...
      <div className={` ${font21.className} bg-white w-[270px] p-5 h-[370px] sm:w-[500px] sm:h-[300px] md:w-[600px] md:h-[420px] absolute z-1 flex flex-col md:p-10   sm:ml-[20rem] md:ml-[42rem]  mt-[15.5rem] md:mt-[10rem]`}>
